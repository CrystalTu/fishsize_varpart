# 1yr (time-interval) lag for temperature
# 20180225

meanA1yr <- matrix(NA,28,2) # West US: 12 species, Alaska: 6 species, North Sea: 9 species
cvA1yr <- matrix(NA,28,2)
...
meanA1yr[1,] <- c(mean(A$X1/M),mean(A$X2))
cvA1yr[1,] <- c(sd(A$X1/M)/mean(A$X1/M),sd(A$X2)/mean(A$X2))
...
meanA1yr[2,] <- c(mean(A$X1/M),mean(A$X2))
cvA1yr[2,] <- c(sd(A$X1/lifehist$M[2])/mean(A$X1/lifehist$M[2]),sd(A$X2)/mean(A$X2))
...
meanA1yr[3,] <- c(mean(A$X1/M),mean(A$X2))
...
meanA1yr[4,] <- c(mean(A$X1/M),mean(A$X2))
...
meanA1yr[5,] <- c(mean(A$X1/M),mean(A$X2))
...
meanA1yr[6,] <- c(mean(A$X1/M),mean(A$X2))
...
meanA1yr[7,] <- c(mean(A$X1/M),mean(A$X2))
...
meanA1yr[8,] <- c(mean(A$X1/M),mean(A$X2))
...
meanA1yr[9,] <- c(mean(A$X1/M),mean(A$X2))
...
meanA1yr[10,] <- c(mean(A$X1/M),mean(A$X2))
...
meanA1yr[11,] <- c(mean(A$X1/M),mean(A$X2))
...
meanA1yr[12,] <- c(mean(A$X1/M),mean(A$X2))
...
meanA1yr[13,] <- c(mean(A$X1/M),mean(A$X2))
...
meanA1yr[14,] <- c(mean(A$X1/M),mean(A$X2))
...
meanA1yr[15,] <- c(mean(A$X1/M),mean(A$X2))
...
meanA1yr[16,] <- c(mean(A$X1/M),mean(A$X2))
...
meanA1yr[17,] <- c(mean(A$X1/M),mean(A$X2))
...
meanA1yr[18,] <- c(mean(A$X1/M),mean(A$X2))
cvA1yr[18,] <- c(sd(A$X1)/mean(A$X1),sd(A$X2)/mean(A$X2))
...
meanA1yr[19,] <- c(mean(A$exploitation/M),mean(A$temperature))
cvA1yr[19,] <- c(sd(A$exploitation/M)/mean(A$exploitation/M),sd(A$temperature)/mean(A$exploitation))
...
meanA1yr[20,] <- c(mean(A$exploitation/M),mean(A$temperature))
cvA1yr[20,] <- c(sd(A$exploitation/M)/mean(A$exploitation/M),sd(A$temperature)/mean(A$exploitation))
...
meanA1yr[21,] <- c(mean(A$exploitation/M),mean(A$temperature))
cvA1yr[21,] <- c(sd(A$exploitation/M)/mean(A$exploitation/M),sd(A$temperature)/mean(A$exploitation))
...
meanA1yr[22,] <- c(mean(A$exploitation/M),mean(A$temperature))
cvA1yr[22,] <- c(sd(A$exploitation/M)/mean(A$exploitation/M),sd(A$temperature)/mean(A$exploitation))
...
meanA1yr[23,] <- c(mean(A$exploitation/M),mean(A$temperature))
cvA1yr[23,] <- c(sd(A$exploitation/M)/mean(A$exploitation/M),sd(A$temperature)/mean(A$exploitation))
...
meanA1yr[24,] <- c(mean(A$exploitation/M),mean(A$temperature))
cvA1yr[24,] <- c(sd(A$exploitation/M)/mean(A$exploitation/M),sd(A$temperature)/mean(A$exploitation))
...
meanA1yr[25,] <- c(mean(A$exploitation/M),mean(A$temperature))
cvA1yr[25,] <- c(sd(A$exploitation/M)/mean(A$exploitation/M),sd(A$temperature)/mean(A$exploitation))
...
meanA1yr[26,] <- c(mean(A$exploitation/M),mean(A$temperature))
cvA1yr[26,] <- c(sd(A$exploitation/M)/mean(A$exploitation/M),sd(A$temperature)/mean(A$exploitation))
...
meanA1yr[27,] <- c(mean(A$exploitation/M),mean(A$temperature))
cvA1yr[27,] <- c(sd(A$exploitation/M)/mean(A$exploitation/M),sd(A$temperature)/mean(A$exploitation))
...
meanA1yr[28,] <- c(mean(A$exploitation/M),mean(A$temperature))
cvA1yr[28,] <- c(sd(A$exploitation/M)/mean(A$exploitation/M),sd(A$temperature)/mean(A$exploitation))
...
write.csv(adjR2Bout,file = "output/adjR2Bout1yrTemp.csv")
write.csv(sigout,file = "output/sigout1yrTemp.csv")
write.csv(meanA1yr,file="output/meanSST1yr_F.csv")
write.csv(cvA1yr,file="output/cvSST1yr_F.csv")
