...
exploitation <- read.csv("~/Desktop/fishsize_varpart/revision/FishingMortality.csv",header=TRUE)
...
A <- data.frame(exploitation$Arrowtooth.flounder[idxF],sst$TEMP[idxSST])
colnames(A)<-c("F","SST")
...
A <- data.frame(cbind(exploitation$Chilipepper.rockfish[idxF],sst$TEMP[idxSST]))
colnames(A)<-c("F","SST")
...
A <- data.frame(cbind(exploitation$Dark.blotched.rockfish[idxF],sst$TEMP[idxSST]))
colnames(A)<-c("F","SST")
...
A <- data.frame(cbind(exploitation$Dover.Sole[idxF],sst$TEMP[idxSST]))
colnames(A)<-c("F","SST")
...
A <- data.frame(cbind(exploitation$English.Sole[idxF],sst$TEMP[idxSST]))
colnames(A)<-c("F","SST")
...
A <- data.frame(cbind(exploitation$Lingcod[idxF],sst$TEMP[idxSST]))
colnames(A)<-c("F","SST")
...
A <- data.frame(cbind(exploitation$Longspine.thornyhead[idxF],sst$TEMP[idxSST]))
colnames(A)<-c("F","SST")
...
A <- data.frame(cbind(exploitation$Petrale.sole[idxF],sst$TEMP[idxSST]))
colnames(A)<-c("F","SST")
...
A <- data.frame(cbind(exploitation$Sardine[idxF],sst$TEMP[idxSST]))[-4,]
colnames(A)<-c("F","SST")
...
A <- data.frame(cbind(exploitation$Splitnose.rockfish[idxF],sst$TEMP[idxSST]))
colnames(A)<-c("F","SST")
...
A <- data.frame(cbind(exploitation$Yelloweye.rockfish[idxF],sst$TEMP[idxSST]))
colnames(A)<-c("F","SST")
...
write.csv(sigF,file = "output/uniSBI_sigF.csv")
write.csv(sigSST,file = "output/uniSBI_sigSST.csv")
write.csv(sigSSTF,file = "output/uniSBI_sigSSTF.csv")
write.csv(r2B,file = "output/uniSBI_r2B.csv")
write.csv(year,file="output/year_analyzed.csv")